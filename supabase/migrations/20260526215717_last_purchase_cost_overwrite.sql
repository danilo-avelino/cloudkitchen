-- 2026-05-26: substitui média ponderada por "custo da última compra" no trigger
-- de stock_movements. Decisão de produto — o estoque deve refletir o valor pago
-- no último recebimento, sem cálculo extra. Cliente espelhado em
-- widgets.jsx::applyStockMovement.
